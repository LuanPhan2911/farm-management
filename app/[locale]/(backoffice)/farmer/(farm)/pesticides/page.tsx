...
import { PesticideCreateButton } from "../../../admin/(farm)/pesticides/_components/pesticide-create-button";
import { PesticidesTable } from "../../../admin/(farm)/pesticides/_components/pesticides-table";
