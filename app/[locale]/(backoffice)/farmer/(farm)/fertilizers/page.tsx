...
import { FertilizerCreateButton } from "../../../admin/(farm)/fertilizers/_components/fertilizer-create-button";
import { FertilizersTable } from "../../../admin/(farm)/fertilizers/_components/fertilizers-table";
